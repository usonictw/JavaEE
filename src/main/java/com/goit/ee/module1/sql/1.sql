...
UPDATE developers SET  salary = 2200 WHERE id = 4;
UPDATE developers SET  salary = 2700 WHERE id = 5;
UPDATE developers SET  salary = 8000 WHERE id = 6;
UPDATE developers SET  salary = 1800 WHERE id = 7;